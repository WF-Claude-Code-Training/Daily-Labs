...
Lab 3 adds **hysteresis** to reduce false positives: a brief spike that self-corrects
should not fire an alert. Only sustained breaches (lasting >= min_duration_minutes)
should alert.
"""
